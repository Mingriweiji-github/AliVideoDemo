...
- (void)startUploadImage{
    [AliyunSVideoApi getImageUploadAuthWithTitle:@"DefaultTitle" filePath:self.coverImagePath tags:@"DefaultTags" handler:^(NSString * _Nonnull uploadAddress, NSString * _Nonnull uploadAuth, NSString * _Nonnull imageURL, NSString * _Nonnull imageId, NSError * _Nonnull error) {
        if (error) {
...
- (void)startUploadVideo{
    [AliyunSVideoApi getVideoUploadAuthWithWithTitle:_videoInfo.title filePath:self.videoPath coverURL:self.coverImageUrl desc:_videoInfo.description tags:_videoInfo.tags handler:^(NSString * _Nonnull uploadAddress, NSString * _Nonnull uploadAuth, NSString * _Nonnull videoId, NSError * _Nonnull error) {
        if (error) {
...
- (void)refreshVideo{
    [AliyunSVideoApi refreshVideoUploadAuthWithVideoId:self.videoId handler:^(NSString * _Nonnull uploadAddress, NSString * _Nonnull uploadAuth, NSError * _Nonnull error) {
        if (error) {
