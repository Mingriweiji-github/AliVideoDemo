...
typedef enum AVPErrorCode: NSUInteger {
    ...
    ERROR_ARTP_STREAM_ILLEGAL         = 0x20013002,
    ERROR_ARTP_STREAM_NOT_FOUND       = 0x20013003,
    ERROR_ARTP_STREAM_STOPPED         = 0x20013004,
    ERROR_ARTP_PLAY_TIMEOUT           = 0x20013005,
    ERROR_ARTP_SPSPPS_AACCONF_TIMEOUT = 0x20013006,
    ERROR_ARTP_PACKET_RECV_TIMEOUT    = 0x20013007,
    ...
    //==========================
    // 2、apsaraplayer编排层错误,
    ERROR_NATIVE_START                = 0x20020000,
    ERROR_READ_PACKET                 = 0x20020001,
    ERROR_BUFFER_STUFFED              = 0x20020002,
