...
- (void)setupParamData {
    ...
    cellModel8.title = @"视频编码方式";
    cellModel8.buttonTitleArray = @[@"硬编",@"软编"];
    cellModel8.placeHolder = @"硬编";
    ...
    if ([self.isClipConfig isEqualToString:@"YES"]) {
        _dataArray = @[cellModel0,cellModel1,cellModel2,cellModel3,cellModel4,cellModel5,cellModel6,cellModel8];
    }else{
