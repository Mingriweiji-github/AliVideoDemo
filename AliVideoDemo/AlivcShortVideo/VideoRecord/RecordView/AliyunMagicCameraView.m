...
- (void)setupSubview
{
    ...
    //topLeft
    UIView *topViewRight = [[UIView alloc] initWithFrame:CGRectMake(0,topY, 80, ScreenHeight - topY)];
    [self addSubview:topViewRight];
    //topRight
    ...
    [self.backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(topViewRight.mas_top);
    ...
    [self.musicButton addTarget:self action:@selector(musicClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    [self.gifPictureButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.circleBtn);
...
//    CGFloat y = self.circleBtn.center.y;
    ...
    [self.finishButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.circleBtn.mas_right).offset(20);
        make.centerY.equalTo(self.circleBtn.mas_centerY);
        make.width.height.mas_equalTo(44);
    }];
    //预览视图+聚焦视图
...
//    self.timeLabel.backgroundColor = [UIColor clearColor];
    ...
    [tapButton setTitle:@"拍15秒" forState:UIControlStateNormal];
    ...
    //Images
//    [_musicButton setBackgroundImage:[UIImage imageNamed:@"shortVideo_music"] forState:UIControlStateNormal];
//    [_backButton setBackgroundImage:[UIImage imageNamed:@"back"] forState:UIControlStateNormal];
//    [_cameraIdButton setBackgroundImage:[UIImage imageNamed:@"shortVideo_camero"] forState:UIControlStateNormal];
//    [_beautyButton setBackgroundImage:[UIImage imageNamed:@"shortVideo_filter"] forState:UIControlStateNormal];
...
- (void)setHide:(BOOL)hide {
    ...
    self.cameraIdButton.hidden = hide;
...
//        _backButton.frame = CGRectMake(30, 22 + (IPHONEX ? 44 : 20), 44, 44);
...
- (QUProgressView *)progressView {
    if (!_progressView) {
        ...
        _progressView.colorProgress = [UIColor colorWithHexString:@"#FF5050" alpha:0.5];
    }
...
- (UIView *)previewView{
    if (!_previewView) {
        _previewView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - 100)];
    }
    return _previewView;
}
