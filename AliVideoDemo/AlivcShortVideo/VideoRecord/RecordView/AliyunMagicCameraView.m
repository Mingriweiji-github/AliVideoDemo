...
//        _leftView = [[AliyunRecordBeautyView alloc] initWithFrame:CGRectMake(0, ScreenHeight-180-78-SafeAreaBottom, ScreenWidth, 180+78+SafeAreaBottom)  titleArray:@[@"美颜",@"美肌"] imageArray:@[@"shortVideo_emotion",@"shortVideo_beautySkin"]];
        _leftView = [[AliyunRecordBeautyView alloc] initWithFrame:CGRectMake(0, ScreenHeight-180-78-SafeAreaBottom, ScreenWidth, 180+78+SafeAreaBottom)  titleArray:@[@"美颜"] imageArray:@[@"shortVideo_emotion"]];
...
- (UIButton *)filterButton{
    if (!_filterButton) {
        ...
        [_filterButton setImage:[UIImage imageNamed:@"shortVideo_filter"] forState:UIControlStateNormal];
